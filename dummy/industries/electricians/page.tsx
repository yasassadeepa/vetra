    ...
    return (
        <>
                ...
                <Container delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-4xl mx-auto">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl text-center font-heading font-semibold !leading-tight mt-6">
                            Professional painting project management software
                        </h1>
                        <p className="paragraph mt-6 max-w-2xl mx-auto">
                            Transform your painting business with our all-in-one solution. From estimating paint quantities to managing crews, we help you deliver exceptional results every time.
                        </p>
            ...
            <Wrapper className="py-10">
                ...
                {[INDUSTRIES[0], INDUSTRIES[1], INDUSTRIES[2]].map((industry, index) => (
