            ...
            <Wrapper>
                <Container delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-2xl mx-auto">
                        <SectionBadge title="New" />
                        <h1 className="text-4xl md:text-5xl lg:text-6xl text-center font-heading font-semibold !leading-tight mt-6">
                            Project management made simple
                        </h1>
                        <p className="paragraph mt-6">
                            Streamline your project workflows with powerful tools that help you plan, track, and deliver projects on time and within budget.
                        </p>
                ...
                <Container delay={0.2} className="w-full">
                    <div className="w-full flex max-w-4xl py-10 mx-auto">
                        <Image
                            src="/images/dashboards/dashboard.png"
                            alt="Dashboard"
                            width={1024}
                            height={1024}
