            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Your Partner in <span className="font-subheading italic">GOLD</span> Trading
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        We make GOLD trading accessible to all. With free education, signals, and live analysis, we empower beginners and pros alike to master the market and grow their financial potential.
                    </p>
                </div>
            </Container>
