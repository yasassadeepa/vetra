...
const SOCIAL_PLATFORMS = [
    { icon: Icons.linkedin, position: 'left-3', size: 'small', iconSize: 'small' },    // Smallest
    { icon: Icons.tiktok, position: 'left-2', size: 'medium', iconSize: 'medium' },  // Medium
    { icon: Icons.insta, position: 'left-1', size: 'large', iconSize: 'large' }, // Largest
    { icon: Icons.youtube, position: 'right-1', size: 'large', iconSize: 'large' },   // Largest
    { icon: Icons.x, position: 'right-2', size: 'medium', iconSize: 'medium' },  // Medium
    { icon: Icons.facebook, position: 'right-3', size: 'small', iconSize: 'small' }   // Smallest
];
    ...
    return (
        <div className="relative flex flex-col items-center justify-center w-full py-20">
            <Container className="relative">
                <div className="flex flex-col items-center text-center max-w-3xl mx-auto absolute top-1/4 inset-x-0">
                    <h2 className="text-2xl md:text-4xl lg:text-6xl font-heading font-semibold !leading-snug">
                        Social Media Integration
                    </h2>
                </div>
                <div className="flex flex-col items-center text-center max-w-3xl mx-auto absolute bottom-1/4 inset-x-0 z-20">
                    <Link href="#">
                        <Button size="lg">
                ...
                <div className="relative flex items-center justify-center overflow-visible">
                    ...
                    {SOCIAL_PLATFORMS.map((platform, index) => (
                        <div
                            key={index}
                            className={cn(
                                "absolute z-20 size-16 p-3 rounded-full flex items-center justify-center borderborder-t-foreground/5 bg-gradient-to-b from-foreground/5 to-transparent shadow-xl shadow-black/10 backdrop-blur-lg transition-all duration-300 hover:scale-110",
